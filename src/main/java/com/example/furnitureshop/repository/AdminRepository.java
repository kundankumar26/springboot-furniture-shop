...
public interface AdminRepository extends JpaRepository<AdminResponse, Long> {
    ...
    @Query(value = "SELECT o.order_id, o.qty, o.is_rejected_by_admin, u.emp_id, u.emp_first_name, " +
            "u.emp_last_name, u.email, p.product_name, \n" +
            "p.product_price, p.product_qty FROM orders_table as o, products as p, users as u " +
            "where o.user_id=u.id and o.product_id=p.product_id;", nativeQuery = true)
    List<EmployeeResponseTable> findAllOrdersForAdmin();
