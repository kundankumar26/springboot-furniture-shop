...
public interface CommentRepository extends JpaRepository<Comment, Long> {
    ...
    @Query(value = "SELECT AVG(rating) FROM comments WHERE product_id=:productId", nativeQuery = true)
    double getRatingFromComments(@Param(value = "productId") long productId);
}
